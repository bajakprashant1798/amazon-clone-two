...
function descreaseCount(itemId) {
...
function generateCartItems(cartItems) {
    ...
    cartItems.forEach((item) => {
        ...
        <div class="cart-item flex items-center pb-4 border-b border-gray-100">
            ...
            <div data-id="${item.id}" class="cart-item-delete w-10 font-bold text-gray-300 hover:text-gray-400">
...
function createEventListeners() {
    let descreaseButtons = document.querySelectorAll(".cart-item-decrease");
    ...
    descreaseButtons.forEach((button) => {
        button.addEventListener("click", function(){
            descreaseCount(button.dataset.id);
        })
    })
